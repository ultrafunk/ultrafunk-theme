...
/*
* THE FOLLOWING LINES MUST BE AT THE END OF THIS FILE!
* They are replaced when running 'npm run build-release' or 'npm run build-debug'
*/

const IS_PROD_BUILD    = true;
const JS_PRELOAD_CHUNK = '/js/dist/chunk-VVSTRTKJ.js';
