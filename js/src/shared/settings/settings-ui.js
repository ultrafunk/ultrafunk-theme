...
import * as debugLogger from '../debuglogger.js?ver=1.41.7';
import { addListener }  from '../utils.js?ver=1.41.7';
import { showSnackbar } from '../snackbar.js?ver=1.41.7';
