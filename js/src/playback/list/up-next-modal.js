...
function loadDragDropTouch()
{
  if (('ontouchstart' in window) && (document.getElementById('drag-drop-touch') === null))
  {
    ...
    tag.src   = debug.isDebug()
                  ? 'https://wordpress.ultrafunk.com/wp-content/themes/ultrafunk/inc/js/drag-drop-touch.js?ver=1.44.41'
                  : 'https://ultrafunk.com/wp-content/themes/ultrafunk/inc/js/drag-drop-touch.min.js?ver=1.44.41';
